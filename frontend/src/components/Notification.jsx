  ...
  return (
    <>
      ...
      <div ref={notificationRef} className="fixed bottom-6 left-6 z-50">
        {menuOpen && (
          <div className="absolute bottom-16 left-0 w-80 max-w-[calc(100vw-3rem)] overflow-hidden rounded-lg border border-base-300 bg-base-100 shadow-xl">
        ...
        >
          ...
          {unreadNotifications > 0 && (
            <span className="absolute -top-1 -right-1 flex min-w-5 h-5 items-center justify-center rounded-full bg-error px-1 text-xs font-bold text-error-content">
